...
{
    // using
    string server = "irc.truewow.org";
    string port = "6667";
    string userName = "HeihachiBot";
    string nickName = "Snuggles";
    string channel = "#bot";
    string userPass = "dumdass1";
    string channelPass = "";
    string serverPass = "";
};
...
private:
    char *port;
    SOCKET ConnectSocket; //the socket descriptor
    int iResult;
    ...
    int sendCommand(int, const char *, ...);
    bool sendPong(char *buf);
    bool msgHandler(char *buf);
};
